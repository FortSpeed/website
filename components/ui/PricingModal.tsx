    ...
    >
      ...
      <div className="p-6 md:p-8 relative">
        ...
        <div className="mb-16 max-md:text-center max-md:mt-10 text-center">
          <h3 className="text-3xl md:text-3xl font-semibold text-white mb-4">
            {plansTitle}
          </h3>
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-center justify-between mb-8">
                      <span className="text-3xl md:text-4xl font-semibold text-white leading-none">
                        {p.number}
                      </span>
                    </div>
          ...
          <form onSubmit={submit} className="grid grid-cols-1 gap-4">
            ...
            <div className="flex items-center justify-between gap-3 pt-2">
              ...
              <InteractiveHoverButton
                type="submit"
                disabled={sending}
                className=" items-center justify-center  text-sm font-medium  disabled:opacity-50"
              >
